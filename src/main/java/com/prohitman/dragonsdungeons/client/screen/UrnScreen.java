...
public class UrnScreen extends AbstractContainerScreen<UrnMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(DragonsDungeons.MODID,
            "textures/gui/urn_gui.png");
    public UrnScreen(UrnMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        guiGraphics.blit(TEXTURE, x, y, 0, 0, 227, 156);
