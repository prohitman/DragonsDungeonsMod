...
public class FoundryResultSlot extends Slot {
    private final Player player;
    private int removeCount;

    public FoundryResultSlot(Player pPlayer, Container pContainer, int pSlot, int pXPosition, int pYPosition) {
    ...
    protected void checkTakeAchievements(ItemStack pStack) {
        ...
        if (player instanceof ServerPlayer serverplayer) {
            ...
            if (container instanceof FoundryBlockEntity abstractfurnaceblockentity) {
