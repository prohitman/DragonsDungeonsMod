...
import com.prohitman.dragonsdungeons.client.screen.slots.FoundryBEFuelSlot;
import com.prohitman.dragonsdungeons.client.screen.slots.FoundryBEOutputSlot;
...
public class FoundryBEMenu extends AbstractContainerMenu {
    public final FoundryBE blockEntity;
    private final Level level;
    private final ContainerData data;

    public FoundryBEMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public FoundryBEMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new FoundryBEFuelSlot(this, iItemHandler, 2, 80, 75)); // Fuel slot
            this.addSlot(new FoundryBEOutputSlot(iItemHandler, 3, 107, 27)); // Output slot
        });
