...
public class ModItems {
    ...
    public static final RegistryObject<Item> AUTOMATON_SPAWN_EGG = ITEMS.register("automaton_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.AUTOMATON, 0x9C523A, 0x39593D, new Item.Properties()));
